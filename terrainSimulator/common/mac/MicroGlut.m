...
// to hack around in a local copy as needed. Furthermore, this also removes
// all old deprecated code, and gives better transparency. (Hack away!)
...
void glutWarpPointer(int x, int y)
{
	...
	mp = [theView convertPoint: mp fromView: nil];

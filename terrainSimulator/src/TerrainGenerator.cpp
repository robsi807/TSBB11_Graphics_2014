...
TerrainGenerator::TerrainGenerator() : worldSeed(12345){ }

TerrainGenerator::TerrainGenerator(long seed) : worldSeed(seed) {}

vec3 TerrainGenerator::calcNormal(vec3 v0, vec3 v1, vec3 v2)
{
...
Model* TerrainGenerator::generateTerrain(TextureData *tex){
...
float TerrainGenerator::calcHeight(Model* mod,float x,float z,int texWidth)
{
  int x0,x1,z0,z1;

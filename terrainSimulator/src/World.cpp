...
World::World(){
  ...
  LoadTGATextureSimple("../textures/conc.tga", &seaTex1);
  glUniform1i(glGetUniformLocation(terrainShader, "seaTex1"), 4); 
  
  GLuint seaTex2;
  glActiveTexture(GL_TEXTURE0+5);
  LoadTGATextureSimple("../textures/dirt.tga", &seaTex2);
  glUniform1i(glGetUniformLocation(terrainShader, "seaTex2"), 5);
  
  // set sea level in terrain shader.
  
  
  glUniform1f(glGetUniformLocation(terrainShader, "seaLevel"), SEA_LEVEL);
